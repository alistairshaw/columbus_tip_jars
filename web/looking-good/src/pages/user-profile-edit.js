                ...
                >
                  ...
                  <FormControl className={classes.formInputs}>
                    <TextField
                      ...
                      helperText={'If you normally work at a at a business, tell us that business name to make you easier to find'}
                      id={'business_name'}
                      label={'Business Name'}
                      name={'business_name'}
                      onBlur={formProps.handleBlur}
                  ...
                  <FormControl className={classes.formInputs}>
                    <TextField
                      ...
                      helperText={'e.g. e.g. Hair Stylist, Muralist, Mixologist, Ninja'}
                      id={'specialty'}
                  ...
                  <p>
                    Give us a few words to preview what we’ll see in your vid and encourage your viewers to share, share, share! Make sure to remind them to tag you and use#TipColumbuswhen they post about how awesome you are!
                  </p>
                  <FormControl className={classes.formInputs}>
                    <TextField
